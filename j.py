...
اسمم محمدالله متعلم صنفدوازدهم
خوب دوستان عزیز مه برایتان یک گفتی
خاص دارم اگر یک لحظه بیکار شودین
     درود بفرستین لطفآ اگر نشود یک در 
 یک مرتبه اگرم نشود در یک هفته یک
م م مممممممممم   BY : FilterXyz \n\x1b[0m───────────────────────────────────────────────────────────────\n {K}[{N}>_{K}] {N}Author   : FilterXyz\n {K}[{N}>_{K}] {N}Github   : FilterXyz\n {K}[{N}>_{K}] {N}Whatsaap : +19725344955\n {K}[{N}>_{K}] {N}Status   : [\x1b[1;92m Premium Bohongan {N}]\n\x1b[0m───────────────────────────────────────────────────────────────""")
#-
def starting():
